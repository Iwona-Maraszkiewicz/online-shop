  ...
  return (
    <div className={styles.root}>      
      ...
      <Slider {...settings} className={styles.slider}>
        ...
        <div className={styles.imageWrapper}>
          <img  alt= '' src='https://images.pexels.com/photos/3661242/pexels-photo-3661242.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'></img>
          <div className={styles.title}>EDUCATIONAL</div>
        </div>
        <div className={styles.imageWrapper}>
          <img  alt= '' src='https://images.pexels.com/photos/4887165/pexels-photo-4887165.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'></img>
